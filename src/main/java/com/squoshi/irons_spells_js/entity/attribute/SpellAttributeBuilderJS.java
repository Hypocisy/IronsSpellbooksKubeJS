...
public class SpellAttributeBuilderJS extends BuilderBase<SpellAttributeBuilderJS> {
	...
	public transient Attribute attribute;
	...
	@Info("""
			...
			""")
	@SuppressWarnings("unused")
	public void setAttribute(MagicRangedAttribute attribute) {
		this.attribute = attribute;
	}

	@Override
	public SpellAttributeBuilderJS createObject() {

		return new SpellAttributeBuilderJS(this.id);
	}
}
